...
Asteroid::Asteroid(Application* a, b2World* w, Vector2f pos, Vector2f vel):Entity(a, w, a->Asteroid,IntRect(0,0,238,174), pos, vel)
{
	...
	b2Vec2 vertices[8];
	vertices[0].Set(-101.f/ppm, -70.f/ppm);
	vertices[1].Set(-113.f/ppm, 28.f/ppm);
	vertices[2].Set(-37.f/ppm, 73.f/ppm);
	vertices[3].Set(65.f/ppm, 79.f/ppm);
	vertices[4].Set(110.f/ppm, 48.f/ppm);
	vertices[5].Set(81.f/ppm, -9.f/ppm);
	vertices[6].Set(55.f/ppm, -37.f/ppm);
	vertices[7].Set(-56.f/ppm, -84.f/ppm);
